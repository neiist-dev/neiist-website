...
const HomePage = () => {
  ...
  return (
    <div style={{height: '100vh'}}>
      ...
      <div style={{margin: '1em 6em 0 6em', position: 'relative', width: 'calc(100% - 12em)', height:'75vh', display: 'flex', flexWrap: 'nowrap',flexFlow: 'column nowrap', alignItems: 'center', justifyContent: 'flex-start', alignContent: 'center', flexDirection: 'column'}}>
        <h1>Núcleo Estudantil de Informática</h1>
        <h2>do Instituto Superior Técnico</h2>
        <p>Um grupo de estudantes motivados para ajudar todo e qualquer aluno de Engenharia Informática e Computadores (e não só), realizando atividades no ambito da informática e apoio social.</p>
      </div>
    </div>
  );
};
