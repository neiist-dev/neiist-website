...
import LocationCard from "../components/contactsPage/LocationCard";
...
const ContactsPage = () => (
  <>
    ...
    <div className={styles.grid}>
      <ContactCard title="Email" content="neiist@tecnico.ulisboa.pt" />
      <ContactCard title="Correio" content={
        <>
    ...
    <div className={styles.grid}>
      <LocationCard roomNumber="Sala 3.03"
        addressLines={[
      ...
      />
      <LocationCard roomNumber="Sala 1.18"
        addressLines={[
          "Campus Taguspark",
