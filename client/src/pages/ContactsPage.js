...
const ContactsPage = () => (
  <div style={{ margin: "10px 20vw" }}>
    ...
    <h2 style={{ textAlign: "center" }}>TELEFONE</h2>
    <p>218417000 (extensão: 2572)</p>
    <h2 style={{ textAlign: "center" }}>SALAS</h2>
    <p>
      Laboratório 1 Pavilhão de Informática 1 Campus Alameda Av. António José de
      Almeida
    </p>
    <iframe
      ...
      height="300"
      frameBorder="0"
      style={{ border: "0", marginRight: "30%" }}
      allowFullScreen
    ></iframe>
    <p>Sala 1.18 Campus Taguspark Av. Prof. Doutor Aníbal Cavaco Silva</p>
    <iframe
    ...
    <p>
      NEIIST (Núcleo Estudantil de Informática do IST) Departamento de
      Engenharia Informática Instituto Superior Técnico Av. Rovisco Pais 1,
      1049-001 LISBOA
    </p>
  </div>
);
