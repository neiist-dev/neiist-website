...
const ElectionCard = ({ election }) => {
    ...
    return (
        <>
            ...
            <ElectionModal election={election} show={show} handleClose={handleClose}/>
        </>
    )
}
        ...
        <Modal size="lg" show={show} onHide={handleClose} centered>
            ...
            <Modal.Body>
                ...
                {results &&
                    <>
                        <h2>Resultados</h2>
                        {results.map(result => <p>{result.name}: {result.count}</p>)}
                    </>
                }
            </Modal.Body>
        </Modal>
            ...
            <Modal.Body>
                <Form>
                    ...
                    <Form.Group>
                        ...
                        <Form.Control type="text" value={options} onChange={event => setOptions(event.target.value)}/>
                    </Form.Group>
                    <Button variant="primary" onClick={() => { handleNewElection(); handleClose(); }}>
                        Submit
                    </Button>
                </Form>
            </Modal.Body>
