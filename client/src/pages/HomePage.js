  ...
  <>
    ...
    <div style={{ margin: "1rem 20vw" }}>
      ...
      <ul>
        ...
        <li>Estimular o interesse pela informática e a divulgação da mesma dentro e fora do Instituto Superior Técnico</li>
        <li>Contribuir para o relacionamento nacional e internacional dos estudantes de informática e de outras áreas afins</li>
        <li>Estimular o associativismo e o espírito de equipa dentro das licenciaturas da responsabilidade do Departamento de Engenharia Informática do Instituto Superior Técnico (DEI)</li>
        <li>Promover a imagem das licenciaturas, mestrados e doutoramentos da responsabilidade do DEI</li>
        <li>Promover o relacionamento entre professores, alunos, profissionais do ramo e empresas</li>
      </ul>
    </div>
    ...
    <div style={{ margin: "1rem 20vw 2rem 20vw", textAlign: "center" }}>
      <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FNEIIST&tabs=timeline&width=500&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId"
        width="500"
        height="500"
        style={{ border: "none" }}
      />
