...
const SocialIcons = () => (
  <div className={style.links}>
    <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', alignContent: 'center', flexDirection: 'row', flexWrap: 'wrap'}}>
  ...
  <div className={style.footer}>
    <div className={style.footerSpace}>
      <div className={style.footerChildSpace}>
        <h6 className={style.h6}>Sobre o núcleo</h6>
        <hr className={style.hr}/>
        <div className={style.p1}><Link as={Link} to="/sobre_nos"><p className={style.p}>Quem Somos?</p></Link></div>
        <div className={style.p1}><Link as={Link} to="/contactos"><p className={style.p}>Contactos</p></Link></div>
        <div className={style.p1}><Link as={Link} to="/estatutos"><p className={style.p}>Estatutos</p></Link></div>
      </div>
      <div className={style.footerChildSpace}>
        <h6 className={style.h6}>Curso de EIC</h6>
        <hr className={style.hr}/>
        <div className={style.p1}>
          <Link as={Link} to={{ pathname: "https://fenix.tecnico.ulisboa.pt/cursos/leic-a" }} target="_blank">
              <p className={style.p}>LEIC-A</p>
          </Link>
          {" / "}
          <Link as={Link} to={{ pathname: "https://fenix.tecnico.ulisboa.pt/cursos/leic-t" }} target="_blank">
            <p className={style.p}>LEIC-T</p>
          </Link>
        </div>
        <div className={style.p1}>
          <Link as={Link} to={{ pathname: "https://fenix.tecnico.ulisboa.pt/cursos/meic-a" }} target="_blank">
            <p className={style.p}>MEIC-A</p>
          </Link>
          {" / "}
          <Link as={Link} to={{ pathname: "https://fenix.tecnico.ulisboa.pt/cursos/meic-t" }} target="_blank">
            <p className={style.p}>MEIC-T</p>
          </Link>
        </div>
        <div className={style.p1}>
          <Link as={Link} to={{ pathname: "https://fenix.tecnico.ulisboa.pt/cursos/deic" }} target="_blank">
            <p className={style.p}>DEIC</p>
          </Link>
        </div>
      </div>
      <div className={style.footerChildSpace}>
        <h6 className={style.h6}>Mais Informações</h6>
        <hr className={style.hr}/>
        <div className={style.p1}><Link as={Link} to="/estudantes"><p className={style.p}>Estudantes</p></Link></div>
        <div className={style.p1}>
          <Link as={Link} to={{ pathname: "https://sinfo.org" }} target="_blank">
            <p className={style.p}>SINFO 30</p>
          </Link>
        </div>
      </div>
      <div className={style.footerChildSpace}>
        <h6 className={style.h6}>Powered By</h6>
        <hr className={style.hrImage}/>
        <Link as={Link} to={{ pathname: "https://dei.tecnico.ulisboa.pt/" }} target="_blank">
          <div className={style.deiImage} style={{backgroundImage: `url(${process.env.PUBLIC_URL}/DEI.png)`}} />
        </Link>
      </div>
    </div>
  </div>
