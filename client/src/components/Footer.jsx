    ...
    <div className={style.footer}>
      <div className={style.footerSpace}>
        <div className={style.footerChildSpace}>
          ...
          <hr/>
          <p><Link as={Link} to="/quemsomos"><p1>Quem Somos?</p1></Link></p>
          <p><Link as={Link} to="/contactos"><p1>Contactos</p1></Link></p>
          <p><Link as={Link} to="/estatutos"><p1>Estatutos</p1></Link></p>
        </div>
        <div className={style.footerChildSpace}>
          <h6>Curso de EIC</h6>
          <hr/>
        ...
        <div className={style.footerChildSpace}>
          ...
          <hr/>
          <p><Link as={Link} to="/estudantes"><p1>Estudantes</p1></Link></p>
          <p>
