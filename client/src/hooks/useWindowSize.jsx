...
const getSize = () => (
/*
  returns an object containing the browser's inner width and inner
  height from the window object.
*/
  {
...
const useWindowSize = () => {
  ...
  useEffect(() => {
    ...
    /*
      event listener that listens to the resize event and will
      invoke a function called handleResize() every time the window is resized.
    */
