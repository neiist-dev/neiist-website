...
import { addValidDepartmentRole, removeValidDepartmentRole, getDepartmentRoles, getUser } from '@/utils/dbUtils';
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (!departmentName || !roleName) {
      return NextResponse.json({ error: 'Department name and role name are required' }, { status: 400 });
    }
