                ...
                <tr key={author.id}>
                  ...
                  <td className="p-2 border">
                    <div className="flex flex-row items-center justify-center gap-2 min-w-[120px]">
                      {editingId === author.id ? (
                        <>
                          <button className="text-green-600 px-2 py-1 rounded hover:bg-green-100 cursor-pointer whitespace-nowrap" onClick={() => handleSave(author)}>Guardar</button>
                        ...
                        <>
                          ...
                          <button className="text-red-600 px-2 py-1 rounded hover:bg-red-100 cursor-pointer whitespace-nowrap" onClick={() => handleDelete(author.id)}>Remover</button>
                        </>
                      )}
                    </div>
                  </td>
