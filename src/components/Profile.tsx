...
export default function ProfileClient({
  ...
  const [showMemberCannotDeleteDialog, setShowMemberCannotDeleteDialog] = useState(false);
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      if (!res.ok) {
        const data = await res.json().catch(() => ({}));
        if (data.error === "member_of_department") {
          setShowMemberCannotDeleteDialog(true);
  ...
  return (
    <>
      ...
      />
      {showMemberCannotDeleteDialog && (
        <div className={styles.memberDialogOverlay}>
          <div className={styles.memberDialog}>
            <div className={styles.memberDialogHeader}>
              <FiInfo className={styles.memberDialogIcon} />
              <span>Conta não pode ser apagada</span>
            </div>
            <div className={styles.memberDialogBody}>
              <p>
                Porque és ou foste membro da equipa NEIIST, a tua conta não pode ser apagada
                automaticamente.
              </p>
              <p>
                Podes remover os teus dados de <strong>GitHub</strong>, <strong>LinkedIn</strong> e{" "}
                <strong>telemóvel</strong> a qualquer momento nesta página.
              </p>
              <p>Para seres completamente esquecido, contacta-nos:</p>
              <a href="mailto:neiist@tecnico.ulisboa.pt" className={styles.memberDialogEmail}>
                <FiMail />
            ...
            <div className={styles.memberDialogActions}>
              <button
                ...
                onClick={() => setShowMemberCannotDeleteDialog(false)}>
                Fechar
              </button>
            </div>
          </div>
