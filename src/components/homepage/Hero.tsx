...
const Hero = () => {
  return (
    <section className={styles.hero}>
        ...
        Informática e <br/> Computadores (e não só), realizando atividades no
        ambito da informática e apoio social.
        </p>
      <div className={styles.campusImages}>
        <div className={styles.alameda}>
          <Image src={heroAlameda} alt="Alameda View" fill priority style={{ objectFit: "cover" }} />
        </div>
        <div className={styles.taguspark}>
          <Image src={heroTaguspark} alt="IST Building" fill priority style={{ objectFit: "cover" }} />
        </div>
      </div>
    </section>
  );
