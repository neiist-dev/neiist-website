...
const Partnerships: React.FC = () => {
  const monetaryPartners = [
    ...
    { href: "https://www.deloitte.com/", src: deloitte, alt: "Deloitte", scale: "1.0" },
    { href: "https://www.basedinlisbon.xyz/", src: basedInLisbon, alt: "Based in Lisbon", scale: "0.9" },
  ];

  const nonMonetaryPartners = [
    { href: "https://lage2.ist.utl.pt/", src: lage2, alt: "LAGE2", scale: "0.75" },
    { href: "https://aiesec.org/", src: aiesec, alt: "AIESEC", scale: "1.0" },
    { href: "https://magmastudio.pt/", src: magma, alt: "Magma Studio", scale: "1.0" },
  ];

  const renderPartners = (partners: { href: string; src: StaticImageData; alt: string; scale: string }[]) =>
