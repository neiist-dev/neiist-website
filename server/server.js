...
const {
  authRoute, areasRoute, thesesRoute, membersRoute, collabsRoute, electionsRoute, adminNewOrgans, adminElectionsRoute, gacRoute
} = require('./routes');
...
app.use('/api/admin/newOrgans', adminNewOrgans);
